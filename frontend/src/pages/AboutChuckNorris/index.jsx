        ...
        <div className='about'>
            ...
            <div>
                <section className='texto'>
                    <h2>Early Life</h2>
                    <br />
                    <p>Chuck Norris, born on March 10, 1940, in Ryan, Oklahoma, is a martial artist, actor, and cultural icon known for his tough-guy image and signature roundhouse kick. Raised in a humble family, Norris developed a strong interest in martial arts while serving in the United States Air Force in South Korea. After returning to the United States, he began competing in karate tournaments, where he won numerous championships, establishing himself as one of the greatest fighters of his time. </p>
                </section>
            ...
            <div>
                <section className='texto'>
                    <h2>Cultural Icon</h2>
                    <br />
                    <p >Chuck Norris also became a pop culture phenomenon with the rise of "Chuck Norris Facts," a series of satirical factoids that exaggerate his abilities and invincibility, turning him into a living legend. These facts further reinforced his tough-guy image, making him a revered and, at the same time, humorous figure in popular imagination.</p>
                </section>
